...
namespace LR1Tools.TIBPropertyDump
{
	internal static class Cli
	{
		...
		private static void PrintHelp()
		{
			...
			Console.WriteLine("  LR1Tools.TIBPropertyDump dump --input-dir <dir> [--output-csv <file>]");
			Console.WriteLine("  LR1Tools.TIBPropertyDump dump --input-file <file> [--output-csv <file>]");
		}
	}
}
