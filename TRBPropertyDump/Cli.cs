...
namespace LR1Tools.TRBPropertyDump
{
	internal static class Cli
	{
		...
		private static void PrintHelp()
		{
			...
			Console.WriteLine("  LR1Tools.TRBPropertyDump dump --input-dir <dir> [--output-csv <file>]");
			Console.WriteLine("  LR1Tools.TRBPropertyDump dump --input-file <file> [--output-csv <file>]");
		}
	}
}
